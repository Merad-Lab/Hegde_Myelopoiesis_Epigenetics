...
SCP::CellDimPlot(sc_obj, group.by = "H_clusters", reduction = "umap", pt.size = 0.75, label = T, label_repel = T, label_insitu = T)
```
...
saveRDS(sc_obj, file = "Hegde_2025_Mouse_BM_Nfe2l2_scRNA.rds")
```
